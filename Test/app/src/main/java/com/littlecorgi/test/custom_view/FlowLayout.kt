package com.littlecorgi.test.custom_view
...
open class FlowLayout @JvmOverloads constructor(
    ...
    protected val mAllViews = ArrayList<ArrayList<View>>()
    protected val mLineHeight = ArrayList<Int>()
    protected val mLineWidth = ArrayList<Int>()
    private var mGravity by Delegates.notNull<Int>()
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val sizeHeight = MeasureSpec.getMode(heightMeasureSpec)
        ...
        setMeasuredDimension(
            if (modeHeight == MeasureSpec.EXACTLY) sizeWidth else width + paddingLeft + paddingRight,
            if (modeWidth == MeasureSpec.EXACTLY) sizeHeight else height + paddingTop + paddingBottom
        )
    }
